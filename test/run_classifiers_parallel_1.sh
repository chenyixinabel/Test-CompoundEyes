...
#Run Hist_Nest
cd $1"/Debug"
./Hist_Nest_parallel_1 $2"Test_v"$3"/"$3"_train/" $2"Test_v"$3"/groundtruth/GT_new_"$3"_train.txt" $2"Test_v"$3"/"$3"_test/" $2"Test_v"$3"/groundtruth/GT_new_"$3"_test.txt" >> results.txt
